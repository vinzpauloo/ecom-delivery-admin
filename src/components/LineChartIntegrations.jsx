      ...
      defs={[
        ...
        // using plain object
        {
          ...
          colors: [
            ...
            { offset: 50, color: "#00FF19", opacity: 0.25 },
            { offset: 50, color: "#00FF19", opacity: 0.55 },
            { offset: 100, color: "#00FF19", opacity: 0.65 },
          ],
        },
      ]}
...
export default LineChartIntegrations;
